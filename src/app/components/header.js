                    ...
                    <li className="menu__item menu__item--social">
                        <Link href="#" className="menu__link" aria-label="Social Icon 1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="25" viewBox="0 0 27 25" fill="none">
                                <path d="M3.962 2.152H7.466L22.952 22.848H19.448L3.962 2.152ZM22.824 0.5L14.782 9.178L8.302 0.5H0.656004L10.55 13.734L0.604004 24.5H2.854L11.586 15.078L18.63 24.5H26.256L15.798 10.52L25.076 0.5H22.824Z" />
                            </svg>
                        </Link>
                        <Link href="#" className="menu__link" aria-label="Social Icon 2">
